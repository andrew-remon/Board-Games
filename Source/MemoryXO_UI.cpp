...
MemoryXO_UI::MemoryXO_UI() : UI<char>("\nWelcome to Our FCAI Memory X-O Game\n", 3)
{
    cout << "This is a Memory Tic Tac Toe Game played by two players.\n";
    cout << "The Rules are as following:\n";
    cout << "Whenaplayerplaces a mark, it is immediately hidden from view. Players must remember the\n";
    cout << "positions of all marks to plan their strategy.\n";
    cout << "The first player to align three of their hidden marks in a row wins. The game is a draw \n";
    cout << "if the board fills without a winner.\n\n";
}
...
Player<char>** MemoryXO_UI::setup_players()
{
...
void MemoryXO_UI::display_board_matrix(const vector<vector<char>>& matrix) const
{
