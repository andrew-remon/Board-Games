 ...
 * Pyramid X-O-specific functionality for player setup and move input.
 *
 * @see UI
 */
...
{
private:
	// Check if the given coordinates are within the pyramid shape
    bool is_in_pyramid(int i, int j) const;

public:
    /**
	* @brief Constructs a PyramidXO_UI object.
    */
    PyramidXO_UI();
	/**
	* @brief Destructor for PyramidXO_UI.
    */
    ~PyramidXO_UI() {};
	/**
