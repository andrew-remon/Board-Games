...
public:
    ...
    void incrementPlayerXSequences()
    {
        playerXSequences++;
    }

    void incrementPlayerOSequences()
    {
        playerOSequences++;
    }

    int getPlayerXSequences()
    {
        return playerXSequences;
    }
    int getPlayerOSequences()
    {
        return playerOSequences;
    }
};
